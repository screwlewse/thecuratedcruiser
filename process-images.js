...
if (fs.existsSync(sourceDir)) {
  ...
  imageFiles.forEach((file) => {
    ...
    sharp(filePath)
      ...
      .catch((err) =>
        console.error(`Error processing ${file} for small size:`, err),
      );
    ...
    sharp(filePath)
      ...
      .catch((err) =>
        console.error(`Error processing ${file} for medium size:`, err),
      );
    ...
    sharp(filePath)
      ...
      .catch((err) =>
        console.error(`Error processing ${file} for large size:`, err),
      );
